...
const getSellerDetails = (sellerID, res) => {
  return new Promise((resolve, reject) => {
    db.getConnection((err, connection) => {
      if (err) {
        ...
        const sql =
          "SELECT sellers.*, stores.* FROM sellers INNER JOIN stores ON sellers.sellerID = stores.sellerID WHERE sellers.sellerID = ?";
        connection.query(sql, [sellerID], (err, results) => {
          console.log(results);
          connection.release();
          if (err) {
  ...
  return new Promise((resolve, reject) => {
    db.getConnection((err, connection) => {
      if (err) {
        ...
        const sql =
          "SELECT * FROM partnerships WHERE receiverID = ? AND status = ? ";
        connection.query(sql, [sellerID, "Active"], (err, results) => {
          connection.release();
          if (err) {
            reject();
          } else {
  ...
  return new Promise((resolve, reject) => {
    db.getConnection((err, connection) => {
      if (err) {
        ...
        const sql =
          "SELECT * FROM partnerships WHERE receiverID = ? AND status = ? ";
        connection.query(sql, [sellerID, "Ended"], (err, results) => {
          connection.release();
          if (err) {
            reject();
          } else {
