...
const GET_PARTNERSHIP_DETAILS = "/sellers/partnerships/ended";

const PartnershipsCanceled = () => {
  const { auth } = useAuth();
        ...
        <section className="m-4 col-span-4">
          <div>
            <ul className="mt-20 mx-14 flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 ">
              ...
              <li className="w-48 rounded-t-lg bg-gray-200  border border-gray-200">
                <Link
...
export default PartnershipsCanceled;
